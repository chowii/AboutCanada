...
object ApiClient {
    ...
    private var service: CognizantService? = null

    fun getService(): CognizantService {
        val retrofit = Retrofit.Builder()
            ...
            .client(okHttpClient)
            .build()
        service = retrofit.create(CognizantService::class.java)
        return this.service!!
    }

    fun getServiceWithTimeout(time: Long, timeUnit: TimeUnit): CognizantService {
        return Retrofit.Builder()
                ...
                .build()
                .create(CognizantService::class.java)
    }
